...
?>
	<li class="thumbnail splash-item" style="margin-bottom:15px; height:auto; padding-bottom:10px;">
		<a href="<?=base_url('fundraise/create/'.$row->id_lsm)?>">
		...
		<span>&nbsp;<i class="icon-map-marker icon-large"></i>&nbsp;&nbsp;<?=get_city($row->id_kota)->name?>, <?=get_province(get_city($row->id_kota)->id_provinsi)->name?></span>
	</li>
<? } ?>