	...
	<body>
				...
				<div class="big-search">
					<div class="row-fluid">
						<div class="span12 wrap">
							<?=langtext('city')?>:&nbsp;
							<select id="id_kota" class="span2" onchange="show_lsm();">
							...
							&nbsp;&nbsp;
							<?=langtext('type')?>:&nbsp;
							<select id="id_lsm_category" class="span2" onchange="show_lsm();">
								<option value=""><?=langtext('all')?></option>
							<?php
							...
							<button class="btn btn-success pull-right" onclick="show_lsm();"><i class="icon-search"></i> <?=langtext('search')?></button>
						</div>
					</div>
				</div>
				<!-- end Big Search -->
		...
		<div class="content-wrap">  
			<div class="container content">
				...
				<select id="sort" class="span2" onchange="show_lsm();">
					<option value="DESC"><?=langtext('latest_joined')?></option>
					<option value="ASC"><?=langtext('oldest')?></option>
				</select>
				<span class="l_area"></span>
				<!--<button class="btn" onclick="reset_lsm();"><i class="icon-refresh"></i> Reload</button>-->
				<br>
				<br>
				<div id="pan" class="row-fluid">
					<ul id="lsm_data" class="pin" style="list-style-type:none;">             
						<!-- the Item -->
