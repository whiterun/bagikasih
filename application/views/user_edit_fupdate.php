				...
				<div class="row-fluid">
					...
					<!-- Right side of detail page -->
						<div class="span10 thumbnail detail-boxes">
							<h4 class="subtitle">Edit Update</h4>
							<?=form_open()?>
								<table>
									<tr>
										<td valign="top">
										...
										<td><textarea class="input-xxlarge" rows="5" name="description" placeholder="<?=langtext('plh_desc_fup')?>" required><?=$fup->description?></textarea></td>
									</tr>
									<tr>
										<td colspan="2">
